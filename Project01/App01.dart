...
void Cadastrar(){ // Menu de Cadastro
  ...
  var digitoL = stdin.readLineSync();
  usuarios.add(digitoL);

  print("Digite uma Senha:");
  var digitoS = stdin.readLineSync();
  usuarios.add(digitoS);

  print("Digite um nome para usuário:");
  var digitoU = stdin.readLineSync();
  usuarios.add(digitoU);
  usuarios.add("500");
